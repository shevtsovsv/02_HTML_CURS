    ...
    try {
      ...
      const steps = [
        ...
        },
        {
          project_id: projectId,
          order: 3,
          instructions: 'Стилизация кнопки\n\nСоздайте красивые стили для кнопки: размер, цвета, эффекты при наведении.',
          validationRules: JSON.stringify([
            { type: 'computedStyle', selector: 'button', property: 'padding', expected: '15px 30px' },
            { type: 'computedStyle', selector: 'button', property: 'border-radius', expected: '25px' }
          ]),
          createdAt: new Date(),
          updatedAt: new Date()
        },
        ...
        },
        {
          project_id: projectId,
          order: 6,
          instructions: 'Финальные улучшения\n\nДобавьте анимации, звуковые эффекты или другие интерактивные элементы для завершения проекта.',
          validationRules: JSON.stringify([
            { type: 'computedStyle', selector: 'button', property: 'transition', expected: 'all 0.3s ease' }
          ]),
          createdAt: new Date(),
          updatedAt: new Date()
        }
      ...
      console.log('✅ Курс "Волшебная кнопка" успешно пересоздан как один проект с 6 шагами!');

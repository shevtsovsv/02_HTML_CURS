    ...
    try {
      ...
      const steps = [
        ...
        },
        {
          ...
          order: 10,
          instructions:
            "Стилизуйте кнопку: градиент, белый цвет, padding 20px 40px, border-radius 50px",
          validationRules: JSON.stringify([
            {
              type: "computedStyle",
        ...
        },
        {
          ...
          order: 11,
          instructions:
            "Добавьте hover эффект для кнопки: transform scale(1.1)",
          validationRules: JSON.stringify([
        ...
        },
        {
          ...
          order: 14,
          instructions:
            'Добавьте обработчик клика: magicButton.addEventListener("click", function() { clickCount++; })',
          validationRules: JSON.stringify([
            {
              type: "jsExpression",
              expression: 'typeof magicButton !== "undefined"',
            },
          ]),
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          order: 15,
          instructions:
            'Добавьте в body div со статистикой: class="stats", h3 и p со span id="click-counter"',
          validationRules: JSON.stringify([

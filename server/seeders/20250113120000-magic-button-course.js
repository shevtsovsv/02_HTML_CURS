      ...
      await queryInterface.bulkInsert("courses", [
        {
          ...
          description:
            'Пошаговое изучение JavaScript через создание интерактивной игры "Волшебная кнопка". Изучите основы программирования, DOM манипуляции, события и создайте свою первую игру!',
          createdAt: new Date(),
          updatedAt: new Date(),
        },
      ]);
    ...
    return queryInterface.bulkInsert("projects", [
      {
        ...
        description:
          "Создаем основную HTML разметку для нашей игры. Изучаем DOCTYPE, мета-теги, структуру документа.",
        order: 1,
        course_id: courseId,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        description:
          "Стилизуем нашу страницу. Изучаем градиенты, Flexbox для центрирования, типографику.",
        order: 2,
        course_id: courseId,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        description:
          "Создаем красивую интерактивную кнопку с анимациями и hover эффектами.",
        order: 3,
        course_id: courseId,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        description:
          "Добавляем интерактивность с помощью JavaScript. Изучаем переменные, события, функции.",
        order: 4,
        course_id: courseId,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        description:
          "Создаем панель статистики. Изучаем DOM манипуляции и динамическое обновление контента.",
        order: 5,
        course_id: courseId,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        description:
          "Добавляем продвинутые функции: звуки, достижения, современный дизайн.",
        order: 6,
        course_id: courseId,
        createdAt: new Date(),
        updatedAt: new Date(),

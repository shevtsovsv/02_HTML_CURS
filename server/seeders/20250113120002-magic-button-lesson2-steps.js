...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    if (projects.length === 0) {
      throw new Error('Проект "Урок 2: CSS стили" не найден. Запустите сначала сидер курса.');
    }
    ...
    return queryInterface.bulkInsert('projectSteps', [
      ...
      },
      {
        ...
        validationRules: JSON.stringify([
          ...
          { "type": "cssRule", "selector": "body", "property": "background", "contains": "135deg" },
          { "type": "cssRule", "selector": "body", "property": "background", "contains": "#667eea" },
          { "type": "cssRule", "selector": "body", "property": "background", "contains": "#764ba2" }
        ]),
        starterCode: JSON.stringify({
          html: '<!DOCTYPE html>\n<html lang="ru">\n<head>\n    <meta charset="UTF-8">\n    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n    <title>Волшебная кнопка</title>\n    <link rel="stylesheet" href="style.css">\n</head>\n<body>\n    <div>\n        <h1>Волшебная кнопка</h1>\n        <p>Нажми на кнопку и увидишь магию!</p>\n        <button>✨ Магия! ✨</button>\n    </div>\n</body>\n</html>',
      ...
      {
        instructions: 'Добавьте к body нулевые отступы (margin: 0; padding: 0;), высоту min-height: 100vh и настройте Flexbox для центрирования (display: flex; align-items: center; justify-content: center;).',
        order: 3,
        project_id: projectId,
        validationRules: JSON.stringify([
          { "type": "cssRule", "selector": "body", "property": "margin", "expected": "0" },
          { "type": "cssRule", "selector": "body", "property": "padding", "expected": "0" },
          { "type": "cssRule", "selector": "body", "property": "min-height", "expected": "100vh" },
          { "type": "cssRule", "selector": "body", "property": "display", "expected": "flex" },
          { "type": "cssRule", "selector": "body", "property": "align-items", "expected": "center" },
          { "type": "cssRule", "selector": "body", "property": "justify-content", "expected": "center" }
        ]),
        starterCode: JSON.stringify({
          html: '<!DOCTYPE html>\n<html lang="ru">\n<head>\n    <meta charset="UTF-8">\n    <meta name="viewport" content="width=device-width, initial-scale=1.0">\n    <title>Волшебная кнопка</title>\n    <link rel="stylesheet" href="style.css">\n</head>\n<body>\n    <div>\n        <h1>Волшебная кнопка</h1>\n        <p>Нажми на кнопку и увидишь магию!</p>\n        <button>✨ Магия! ✨</button>\n    </div>\n</body>\n</html>',
      ...
      {
        instructions: 'Добавьте класс "game-container" к div в HTML, установите белый цвет текста для body (color: white;) и создайте CSS правило для .game-container с text-align: center.',
        order: 4,
        project_id: projectId,
        validationRules: JSON.stringify([
      ...
      {
        instructions: 'Создайте CSS правило для h1 с размером шрифта 2.5rem, отступом снизу 10px и тенью текста 0 2px 4px rgba(0, 0, 0, 0.3).',
        order: 5,
        project_id: projectId,
        validationRules: JSON.stringify([
          { "type": "cssRule", "selector": "h1", "property": "font-size", "expected": "2.5rem" },
          { "type": "cssRule", "selector": "h1", "property": "margin-bottom", "expected": "10px" },
          { "type": "cssRule", "selector": "h1", "property": "text-shadow", "contains": "0 2px 4px rgba(0, 0, 0, 0.3)" }
        ]),
        starterCode: JSON.stringify({
      ...
      {
        instructions: 'Добавьте класс "subtitle" к параграфу в HTML и создайте CSS правило для .subtitle с размером шрифта 1.2rem, отступом снизу 30px и прозрачностью 0.9.',
        order: 6,
        project_id: projectId,
        validationRules: JSON.stringify([
          { "type": "elementExists", "selector": "p.subtitle" },
          { "type": "cssRule", "selector": ".subtitle", "property": "font-size", "expected": "1.2rem" },
          { "type": "cssRule", "selector": ".subtitle", "property": "margin-bottom", "expected": "30px" },
          { "type": "cssRule", "selector": ".subtitle", "property": "opacity", "expected": "0.9" }
        ]),
        starterCode: JSON.stringify({

...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert("projectSteps", [
      ...
      {
        instructions:
          "Добавьте к body: margin: 0, padding: 0, min-height: 100vh, display: flex, align-items: center, justify-content: center, color: white.",
        order: 3,
        project_id: projectId,
        validationRules: JSON.stringify([
          {
      ...
      {
        instructions:
          'Добавьте класс "game-container" к div в HTML и создайте CSS правило .game-container с text-align: center.',
        order: 4,
        project_id: projectId,
        validationRules: JSON.stringify([

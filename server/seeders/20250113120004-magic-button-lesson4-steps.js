...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert("projectSteps", [
      ...
      {
        instructions:
          'Получите ссылку на кнопку с помощью document.querySelector(".magic-button") и сохраните в константу magicButton.',
        order: 2,
        project_id: projectId,
        validationRules: JSON.stringify([
      ...
      {
        instructions:
          "Добавьте обработчик события click к кнопке. В функции увеличивайте clickCount и выводите в консоль количество кликов.",
        order: 3,
        project_id: projectId,
        validationRules: JSON.stringify([
      ...
      {
        instructions:
          "Создайте массив magicPhrases с волшебными фразами и добавьте показ случайной фразы через alert в обработчик клика.",
        order: 4,
        project_id: projectId,
        validationRules: JSON.stringify([
